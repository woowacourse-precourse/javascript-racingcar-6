describe("문자열 테스트", () => {
  test("split 메서드로 주어진 값을 구분", () => {
    ...
    const result = input.split(",");
      /// code input
    console.log("split 메서드로 주어진 값을 구분");
      ///
  ...
  test("split 메서드로 구분자가 포함되지 않은 경우 값을 그대로 반환", () => {
    ...
    const result = input.split(",");
    ///
    console.log("split 메서드로 구분자가 포함되지 않은 경우 값을 그대로 반환");
    ///
  ...
  test("substring 메서드로 특정 구간 값을 반환", () => {
    ...
    const result = input.substring(1, 4);
      ///
      console.log("substring 메서드로 특정 구간 값을 반환");
      ///
  ...
  test("at 메서드로 특정 위치의 문자 찾기", () => {
    ...
    ///
    console.log("at 메서드로 특정 위치의 문자 찾기");
    ///
