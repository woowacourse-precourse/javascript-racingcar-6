...
import { CAR_INPUT_DUPLICATE_PATTERN, CAR_INPUT_PATTERN, CAR_MOVE_INPUT_PATTERN, validate } from '../src/validate';
...
describe('재시도 횟수 입력값 검증 테스트', () => {
  test('숫자가 아님', () => {
    ...
    expect(validate(input, CAR_MOVE_INPUT_PATTERN)).toBe(false);
  });
