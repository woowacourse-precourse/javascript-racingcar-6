...
describe('Race 클래스 테스트', () => {
  ...
  describe('pickNumberInRange 함수', () => {
    test('0부터 9 사이의 숫자를 반환', () => {
  ...
  describe('generateRandomNumber 메서드', () => {
    test('4 이상의 랜덤 숫자가 생성되면 true를 반환', () => {
      jest.spyOn(Random, 'pickNumberInRange').mockReturnValue(4);
      const result = race.generateRandomNumber();
      expect(result).toBeTruthy();
    });

    test('4 미만의 랜덤 숫자가 생성되면 false를 반환', () => {
  ...
  describe('runRace 메서드', () => {
    test('carArr과 carDictionary를 받아서 랜덤으로 점수를 부여', () => {
  ...
  describe('printRace 메서드', () => {
    test('carDictionary를 받아서 결과를 출력', () => {
