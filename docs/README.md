...
### 🟥 **1. 자동차 생성 및 이름 부여**
- 💡 요구 사항 및 기능
  - [] 사용자는 여러 대의 자동차를 생성하기
  - [] 각 자동차에는 이름을 부여할 수 있으며, 이름은 쉼표(,)를 기준으로 구분. 이름은 5자 이하만 허용합니다.

<br/>

### 🟥 **2. 이동 시도 횟수 입력**
- 💡 요구 사항 및 기능
  - [] 사용자는 몇 번의 이동을 시도할 것인지 입력할수 있는 기능

<br/>

### 🟥 **3. 자동차 이동 로직**
- 💡 요구 사항 및 기능
    - [] 주어진 횟수 동안, 각 자동차는 전진 또는 멈출 수 있는 기능
    - [] 전진 조건은 0에서 9 사이에서 무작위 값을 생성하고, 무작위 값이 4 이상일 경우 자동차가 전진한다

<br/>

### 🟥 **4. 각 차수별 실행 결과 출력**
- 💡 요구 사항 및 기능
  - [] 주어진 횟수 동안, 각 자동차가 전진 또는 멈췄을때 해당 차수별로 실행 결과를 출력하는 기능

<br/>

### 🟥 **5. 오류 처리**
- 💡 요구 사항 및 기능
  - [] 사용자가 잘못된 값을 입력한 경우, 예외를 발생시켜야 합니다. 예외 메시지는 "[ERROR]"로 시작해야 하며, 애플리케이션은 종료됩니다.
...
### 🟥 **6. 우승자 결정**
- 💡 요구 사항 및 기능
  - [] 자동차 경주가 종료된 후, 누가 우승했는지를 알려주는 기능
