...
1. 자동차 이름 입력
 [o] 자동차 이름은 5자 초과인 경우 예외처리 
 [o] 자동차 2대 이상이 아닌 경우 예외처리
 [o] 자동차 이름은 ','로 구분
 [o] 자동차 이름이 중복인 경우 예외처리

 2. 전진 횟수 입력
 [o] 사용자가 입력 횟수를 입력하지 않거나 0, 문자일 경우 예외처리
 [o] 0~9까지 숫자 중 무작위 값 선택(4이상 전진 / 4미만 멈춤)
 [o] 전진은 '-' 로 표시

 3. 경기 결과 출력
 [o] 단독 우승일 경우 자동차 이름 1개만 표시, 공동 우승일 경우 ',' 사용으로 표시 
