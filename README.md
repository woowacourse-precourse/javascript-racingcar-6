...
- [x] 경주 게임을 관리하는 RacingGame 클래스를 새로운 파일로 분리
- [x] 화면에 출력하는 문구를 저장하는 Messages 객체를 새로운 파일로 분리
- [x] 경주할 자동차 이름 입력받기 - setCarName
...
- [x] 각 자동차 별로 전진 여부 확인해서 차수별 실행 결과 출력 - printCarPosition
- [x] 가장 멀리 간 자동차를 확인해서 우승자 이름 출력
