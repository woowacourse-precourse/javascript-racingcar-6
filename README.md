...
- [x] MVC 패턴 사용 폴더 구조 구성
- [x] 한 함수는 하나의 기능만 한다.
- [x] scope depth는 2를 넘지 않는다.

### 필수 기능

- [x] 두번의 readlineAsync 를 이용한 인풋 받기
- [x] 프로그램 시작과 함께 readlineAsync 입력 받기
- [x] 쉼표로 구분된 이름 파싱
- [x] 자동차는 객체에 저장하기
- [x] 시도할 횟수 인풋 입력 받기
- [x] 시도할 횟수만큼 자동차 움직임 반복
- [x] 자동차 움직임을 결정할 random 함수 구성
- [x] 반복 종료 후 우승자 판별 알고리즘
- [x] 우승자 판단을 위해 최대 움직인 자동차의 움직임 횟수를 저장한다

### 예외처리

- [x] 중복된 자동차 이름 처리
- [x] 자동차 이름은 5자리가 넘으면 안된다
- [x] 자동차 이름은 쉼표로 구분되어야 한다
- [x] 쉼표 사이에 공백이 들어왔을때 처리
- [x] 시도할 횟수에 대한 예외처리
- [x] 엄청 큰 숫자에 대한 처리
- [x] 숫자가 아닐때 혹은 0이 입력으로 들어왔을때 처리
