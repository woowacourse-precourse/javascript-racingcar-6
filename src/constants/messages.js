...
export const ERROR_MESSAGE = Object.freeze({
  ...
  INPUT_CARS_LESS_THAN_MIN: `${ERROR_MESSAGE_PREFIX} ${CARS.MIN_NUMBER_OF_CARS}대 이상의 자동차를 입력해주세요.`,
  ...
  LESS_THAN_MIN: `${ERROR_MESSAGE_PREFIX} ${RACING.MIN_NUMBER_OF_ATTEMPTS} 이상의 수를 입력해 주세요.`,
  MORE_THAN_MAX: `${ERROR_MESSAGE_PREFIX} ${RACING.MAX_NUMBER_OF_ATTEMPTS} 이하의 수를 입력해 주세요.`,
});
