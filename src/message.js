...
class Message {
  ...
  carInputErrorMessage = `[ERROR] 자동차 이름은 ${MAX_NAME_LENGTH}자 이하만 가능합니다.`;
  carInputErrorMessage2 = `[ERROR] 자동차 이름은 공백이 될 수 없습니다.`;
  carInputErrorMessage3 = `[ERROR] 자동차 이름은 중복될 수 없습니다.`;
  carInputErrorMessage4 = `[ERROR] 자동차 이름은 ${MIN_CAR_COUNT}개 이상이어야 합니다.`;
  carInputErrorMessage5 = `[ERROR] 한번에 ${MAX_CAR_COUNT}대 까지의 자동차만 경주 할 수 있습니다..`;
