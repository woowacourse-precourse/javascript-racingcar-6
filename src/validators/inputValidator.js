...
export class InputValidator {
  static validateNumber(RACE_ROUND) {
    ...
    if (ROUND < GameSetting.minRaceLimit) throw new Error(GameErrorMsg.numberOutOfRangeError);
    if (GameSetting.maxRaceLimit < ROUND) throw new Error(GameErrorMsg.numberOutOfRangeError);
  }
