export const INPUT_NUMBER_ERR_MSG = '[ERROR] 숫자가 잘못된 형식입니다.';
export const PLAYER_NUMBER_ERR_MSG = '[ERROR] 최소 2명 이상 입력하세요';
export const PLAYER_NAME_ASK_MSG = '경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)\n';
